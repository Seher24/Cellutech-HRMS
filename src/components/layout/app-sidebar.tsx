...
export function AppSidebar({
  ...
  return (
    <aside className="flex h-full min-h-dvh w-full flex-col border-r border-slate-800/80 bg-[#0b1220] text-slate-100">
      ...
      <div className="mt-auto shrink-0 border-t border-slate-800 p-4 space-y-1">
